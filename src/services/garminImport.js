...
export function mapGarminActivity(activity) {
  ...
  return {
    ...
    normalizedPower: activity.normalizedPower ? Math.round(Number(activity.normalizedPower)) : null,
    ftp: activity.functionalThresholdPower ? Math.round(Number(activity.functionalThresholdPower)) : null,
...
export function mergeGarminActivities(existing, imported) {
  ...
  imported.forEach((garminActivity) => {
    ...
    result[index] = {
      ...
      normalizedPower: current.normalizedPower ?? garminActivity.normalizedPower,
      ftp: current.ftp ?? garminActivity.ftp,
