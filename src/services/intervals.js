...
export function mapIntervalsActivity(activity) {
  ...
  return {
    ...
    averagePower: activity.average_watts ?? activity.average_power ?? null,
    normalizedPower: activity.icu_weighted_avg_watts ?? activity.weighted_average_watts ?? activity.normalized_power ?? null,
    ftp: activity.icu_ftp ?? activity.ftp ?? null,
...
export function mergeIntervalsActivities(existing, imported) {
  ...
  imported.forEach((intervalsActivity) => {
    ...
    result[index] = {
      ...
      averagePower: intervalsActivity.averagePower ?? current.averagePower,
      normalizedPower: intervalsActivity.normalizedPower ?? current.normalizedPower,
      ftp: intervalsActivity.ftp ?? current.ftp,
